 ...
 */
public class TvJxRecyclerAdapter extends AbsRecyclerAdapter<VideoCategory> {

    public TvJxRecyclerAdapter(Context context, int layoutRes, List<VideoCategory> datas, int
            anmiationRes) {
        ...
        if (!data.getName().equals("index_flash") && position != 0) {
            ...
            img1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(video.getWorks_id());
                }
            });
            ...
            try {
                ...
                ImageLoader.getInstance().displayImage(data.getVideos().get(0).getImgh_url() ==
                        null ? data.getVideos().get(0).getImgv_url() : data.getVideos().get(0)
                        .getImgh_url(), head, BaseApp.getDisplayImageOptions(new
                        FadeInBitmapDisplayer(0)));
