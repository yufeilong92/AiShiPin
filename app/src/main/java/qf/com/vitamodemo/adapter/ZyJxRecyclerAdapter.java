...
import qf.com.vitamodemo.ui.ZyInfoActivity;

/**
 * Created by Administrator on 2015/10/11 0011.
 */
public class ZyJxRecyclerAdapter extends AbsRecyclerAdapter<VideoCategory> {

    public ZyJxRecyclerAdapter(Context context, int layoutRes, List<VideoCategory> datas, int
            anmiationRes) {
        ...
        if (!data.getName().equals("index_flash") && position != 0) {
            ...
            img1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    VideoCategory.VideosEntity video = data.getVideos().get(0);
                    startActivity(video.getWorks_id() == null ? video.getOther_works_id() : video
                            .getWorks_id());
                }
            });
            img2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    VideoCategory.VideosEntity video = data.getVideos().get(1);
                    startActivity(video.getWorks_id() == null ? video.getOther_works_id() : video
                            .getWorks_id());
                }
            });
            img3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    VideoCategory.VideosEntity video = data.getVideos().get(2);
                    startActivity(video.getWorks_id() == null ? video.getOther_works_id() : video
                            .getWorks_id());
                }
            });
            img4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    VideoCategory.VideosEntity video = data.getVideos().get(3);
                    startActivity(video.getWorks_id() == null ? video.getOther_works_id() : video
                            .getWorks_id());
                }
            });
            img5.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    VideoCategory.VideosEntity video = data.getVideos().get(4);
                    startActivity(video.getWorks_id() == null ? video.getOther_works_id() : video
                            .getWorks_id());
                }
            });
            ...
            try {
                ...
                ImageLoader.getInstance().displayImage(data.getVideos().get(0).getImgh_url() ==
                                null ?
                                data.getVideos().get(0)
                                        .getImgv_url() : data.getVideos().get(0).getImgh_url(),
                        head,
                        BaseApp
                                .getDisplayImageOptions(new FadeInBitmapDisplayer(0)));
    ...
    private void startActivity(String id) {
        Intent intent = new Intent(context, ZyInfoActivity.class);
        intent.putExtra(Config.URL, UrlConstants.URL_ZY_INFO + id);
