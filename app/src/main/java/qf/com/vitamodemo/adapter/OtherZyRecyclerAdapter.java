 ...
 */
public class OtherZyRecyclerAdapter extends AbsRecyclerAdapter<OtherTvBean> {

    public OtherZyRecyclerAdapter(Context context, int layoutRes, List<OtherTvBean> datas, int
            anmiationRes) {
    ...
    public void showData(MyViewHolder vHolder, final OtherTvBean data, int
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(UrlConstants.URL_ZY_INFO + data.getWorks_id());
            }
        });
