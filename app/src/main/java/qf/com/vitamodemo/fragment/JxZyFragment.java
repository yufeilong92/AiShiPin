...
import qf.com.vitamodemo.adapter.ZyJxRecyclerAdapter;
 ...
 */
public class JxZyFragment extends BaseRecyclerFragment {

    private List<VideoCategory> datas = new ArrayList<>();
    private ZyJxRecyclerAdapter adapter;

    public static JxZyFragment newInstance(String url) {
        JxZyFragment f = new JxZyFragment();
    ...
    public RecyclerView.Adapter getBaseRecyclerAdapter() {
        adapter = new ZyJxRecyclerAdapter(getContext(), R.layout.item_tv_jx, datas, R.anim
                .list_anim);
        return adapter;
    }
