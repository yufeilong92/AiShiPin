...
import qf.com.vitamodemo.adapter.OtherDmRecyclerAdapter;
 ...
 */
public class OtherDmFragment extends BaseRecyclerFragment {

    private OtherDmRecyclerAdapter adapter;

    public static OtherDmFragment newInstance(String url) {
        OtherDmFragment f = new OtherDmFragment();
    ...
    public RecyclerView.Adapter getBaseRecyclerAdapter() {
        adapter = new OtherDmRecyclerAdapter(getContext(), R.layout.item_other, new
