...
import qf.com.vitamodemo.adapter.TvJxRecyclerAdapter;
 ...
 */
public class JxTvFragment extends BaseRecyclerFragment {

    private List<VideoCategory> datas = new ArrayList<>();
    private TvJxRecyclerAdapter adapter;

    public static JxTvFragment newInstance(String url) {
        JxTvFragment f = new JxTvFragment();
    ...
    public RecyclerView.Adapter getBaseRecyclerAdapter() {
        adapter = new TvJxRecyclerAdapter(getContext(), R.layout.item_tv_jx, datas, R.anim
                .list_anim);
        return adapter;
    }
